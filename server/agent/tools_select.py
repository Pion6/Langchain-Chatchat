...
tools = [
    ...
    StructuredTool.from_function(
        ...
        args_schema=CourseScheduleSchema2,
    ),
    Tool.from_function(
        func=weathercheck,
        name="weather_check",
    ...
    # course_schedule_check2(),
    # Tool.from_function(
    #     func=course_schedule_check,
    #     name="course_schedule_check",
    #     description="Useful for when you need to answer questions about the course timetable.",
    #     args_schema=CourseScheduleSchema,
    # ),
    # Tool.from_function(
    #     func=arxiv,
    #     name="arxiv",
